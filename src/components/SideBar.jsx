...
const Wrapper = styled.div`
  ...
  height: 100%;
  border-radius: 10px;
  background-image: url("https://raw.githubusercontent.com/SharatRokkam/MERN-multi-step-form/dcced86bf3df888b7d436c21a346154b9966c489/assets/images/bg-sidebar-desktop.svg");
...
const SideBar = ({ step, isMobileWidth }) => {
  ...
  return (
    <Container
      className={isMobileWidth ? "" : "animate__animated animate__fadeInDownSmall"}
    >
      <Wrapper>
        <BoxContainer>
